 ...
 */
package ejercicio_59906practicas;
 ...
 * @author carri
 */
public class Ejercicio_59906practicas {
    ...
    */
    ...
    public static void ESCOGER(int numeroEscogido){
        ...
        switch(numeroEscogido){
            case 1:
                ...
                String palabra = miConsola.nextLine().toUpperCase();
                String mayuscula = miConsola.nextLine().toUpperCase();
                
                char caPal[] = palabra.toCharArray();
              
                Codigo();
                
                bucle(palabra, caPal);
                System.out.println(Pagar(palabra, caPal));
                break;
            ...
            case 2:
                ...
                String genero = miConsola.nextLine();
                
                Personajes();
                //bucle donde se imprimiran los personajes
                recorrido(genero);
                break;
            ...
            case 3:
                ...
                preguntas();
                System.out.println();
                System.out.println("Obtuviste un " + cont + "0 de Calificacion");
                break;
    ...
    public static void Codigo(){
        ...
        //representacion en código Morse
        aCodigo[0][1] = ".-";
        aCodigo[1][1] = "-...";
        aCodigo[2][1] = "-.-.";
        aCodigo[3][1] = "-..";
    ...
    public static String caracter(char caracter) {
        ...
        int n_ca = (int) caracter;
      
        return aCodigo[n_ca - 65][0] + " " + aCodigo[n_ca - 65][1];
    }
    
    public static void bucle(String palabra, char caPal[]){
       
        for (int i = 0; i < palabra.length(); i++) {
           
            if(String.valueOf(caPal[i]).equals(" ")){
                System.out.println("");
           
            } else {
                System.out.println(caracter(caPal[i]));
            }
        }
    }
    
    public static String Pagar(String palabra, char caPal[]){
        ...
        return "Numero de palabras: " + cont + "\n" + "Son $" + PRECIO + " pesos";
    }
    ...
    public static void preguntas(){
        ...
        for (int i = 0; i < preguntas.length; i++) {
            ...
            System.out.println();
            System.out.print("por favor escribe tu respuesta: ");
            respuesta = miConsola.nextLine();
